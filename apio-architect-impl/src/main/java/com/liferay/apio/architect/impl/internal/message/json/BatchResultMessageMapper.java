 ...
 * starts and finishes the batch result, respectively. The methods {@link
 * #onStartItem} and {@link #onFinishItem} are called when the writer starts and
 * finishes an item, respectively. The rest of batch result message mapper's
